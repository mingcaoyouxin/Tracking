package com.tracking.sdkexample;


import java.util.ArrayList;

import com.tracking.R;
import com.tracking.sdkexample.adapter.ImageGridAdapter;
import com.tracking.sdkexample.model.ImageInfo;
...
public class ResultActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sdk_activity_result);
