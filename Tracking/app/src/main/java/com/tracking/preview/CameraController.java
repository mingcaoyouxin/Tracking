...
public class CameraController
    ...
    public int mCameraIndex = Camera.CameraInfo.CAMERA_FACING_BACK;//默认启动前置摄像头
    ...
    public void setCameraCallBack(final CameraPreViewDataCallback dataCallback) {
