...
public class FullFrameRect {
    ...
    public void setFilterTwo(IFilter filterTwo) {
        mFilterTwo= filterTwo;
    }
    ...
    public void drawFrame(int textureId, float[] texMatrix) {
        ...
        /*mFilterTwo.onDraw(IDENTITY_MATRIX, mRectDrawable.getVertexArray(), 0,
                mRectDrawable.getVertexCount(), mRectDrawable.getCoordsPerVertex(),
                mRectDrawable.getVertexStride(), texMatrix, mRectDrawable.getTexCoordArray(),
                textureId, mRectDrawable.getTexCoordStride());*/
    }
